...
class AboutStrings < Neo::Koan
  def test_double_quoted_strings_are_strings
    string = "Hello, World"
    assert = "Hello, World", string.is_a?(String)
  end

  def test_single_quoted_strings_are_also_strings
    string = 'Goodbye, World'
    assert = 'Goodbye, World', string.is_a?(String)
  end
...
# => "It was the best of times,\nIt was the worst of times.\n"
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # plus equals operator (+=) when building up strings.  Why?
      ...
      # Shovel operator is better because: 
      #  - It's faster, and THAT's because...
      #  - It's not creating a new object_id, whereas (+=) will create new object_id
  end
